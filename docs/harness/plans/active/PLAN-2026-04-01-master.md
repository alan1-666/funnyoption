...
| TASK-OFFCHAIN-020 | active | worker | TASK-OFFCHAIN-019 | remove meta/explanatory design copy from the detail page and codify one strict frontend surface-copy guideline |
