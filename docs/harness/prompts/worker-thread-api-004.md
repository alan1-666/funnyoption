...
8. /Users/zhangza/code/funnyoption/docs/harness/worklogs/WORKLOG-API-003.md
9. /Users/zhangza/code/funnyoption/docs/harness/tasks/TASK-API-004.md
10. /Users/zhangza/code/funnyoption/docs/harness/handshakes/HANDSHAKE-API-004.md
11. /Users/zhangza/code/funnyoption/docs/harness/worklogs/WORKLOG-API-004.md

执行目标：
- 明确 privileged bootstrap order 的 semantic uniqueness policy
- 避免只靠新的 `requested_at` 就静默通过第二笔 otherwise-identical bootstrap sell order
...
- 如果需要在“禁止同语义第二笔 bootstrap”与“允许第二笔但要求显式 distinct action handle”之间取舍，优先选择当前 repo 最容易验证、边界最清晰的一种，并把理由写回 WORKLOG-API-004.md
