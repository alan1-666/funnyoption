...
- Frontend surface-copy cleanup and guideline task: [`docs/harness/tasks/TASK-OFFCHAIN-020.md`](/Users/zhangza/code/funnyoption/docs/harness/tasks/TASK-OFFCHAIN-020.md)
...
- Next worker focus:
  ...
  - `TASK-OFFCHAIN-020` is complete: the detail page no longer exposes
    meta/design-rationale copy to users, and the repo now has one explicit
    frontend surface-copy guideline for future UI work
