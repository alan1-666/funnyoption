...
FUNNYOPTION_LOCAL_CHAIN_MODE='anvil'
FUNNYOPTION_CHAIN_RPC_URL='${RPC_URL}'
FUNNYOPTION_CHAIN_RPC_FALLBACK_URLS=''
FUNNYOPTION_CHAIN_OPERATOR_PRIVATE_KEY='${OPERATOR_PRIVATE_KEY}'
FUNNYOPTION_CHAIN_NAME='anvil'
FUNNYOPTION_NETWORK_NAME='local'
FUNNYOPTION_CHAIN_ID='${FUNNYOPTION_LOCAL_CHAIN_CHAIN_ID}'
FUNNYOPTION_VAULT_ADDRESS='${VAULT_ADDRESS}'
FUNNYOPTION_CHAIN_CONFIRMATIONS='0'
FUNNYOPTION_CHAIN_START_BLOCK='${start_block}'
FUNNYOPTION_CHAIN_POLL_INTERVAL='1s'
FUNNYOPTION_CHAIN_CLAIM_POLL_INTERVAL='3s'
FUNNYOPTION_CHAIN_GAS_LIMIT='250000'
FUNNYOPTION_COLLATERAL_TOKEN_ADDRESS='${TOKEN_ADDRESS}'
FUNNYOPTION_COLLATERAL_SYMBOL='USDT'
FUNNYOPTION_COLLATERAL_DECIMALS='6'
FUNNYOPTION_COLLATERAL_ACCOUNTING_DECIMALS='2'
FUNNYOPTION_FRONTEND_CHAIN_NAME='Anvil Local'
FUNNYOPTION_CHAIN_EXPLORER_URL=''
FUNNYOPTION_NATIVE_CURRENCY_NAME='Ethereum'
FUNNYOPTION_NATIVE_CURRENCY_SYMBOL='ETH'
FUNNYOPTION_NATIVE_CURRENCY_DECIMALS='18'
FUNNYOPTION_OPERATOR_WALLETS='${OPERATOR_ADDRESS}'
EOF

  cat >"${LOCAL_CHAIN_WALLETS}" <<EOF
FUNNYOPTION_LOCAL_CHAIN_OPERATOR_ADDRESS=${OPERATOR_ADDRESS}
FUNNYOPTION_LOCAL_CHAIN_OPERATOR_PRIVATE_KEY=${OPERATOR_PRIVATE_KEY}

FUNNYOPTION_LOCAL_CHAIN_BUYER_USER_ID=1001
FUNNYOPTION_LOCAL_CHAIN_BUYER_ADDRESS=${BUYER_ADDRESS}
FUNNYOPTION_LOCAL_CHAIN_BUYER_PRIVATE_KEY=${BUYER_PRIVATE_KEY}

FUNNYOPTION_LOCAL_CHAIN_MAKER_USER_ID=1002
FUNNYOPTION_LOCAL_CHAIN_MAKER_ADDRESS=${MAKER_ADDRESS}
FUNNYOPTION_LOCAL_CHAIN_MAKER_PRIVATE_KEY=${MAKER_PRIVATE_KEY}
EOF
}
